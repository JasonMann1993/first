...
use App\Http\Requests\Manage\Management\CoalGassRequest;
use Carbon\Carbon;
use App\Models\AuditLog;

class CoalGassesController extends BaseController
{
    /**
     *       煤气管理
     *      - 状态
    ...
    public function index(Request $request)
    {
        ...
        $lists = CoalGass::latest('id')->where($where)->paginate(10);
        return view('manage.coalgasses.index', compact('lists'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('manage.coalgasses.edit', compact('info'));
    }
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function audit(CoalGassRequest $request, $id)
    {
        $info = CoalGass::findOrFail($id);
        # 修改 status
     ...
     * @return bool|null
     */
    public function update(CoalGassRequest $request, $id)
    {
        $info = CoalGass::findOrFail($id);
    ...
    public function show($id)
    {
        ...
        return view('manage.coalgasses.show', compact('info'));
    }
