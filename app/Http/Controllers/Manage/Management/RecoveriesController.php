...
use App\Http\Requests\Manage\Management\RecoveryRequest;
use Carbon\Carbon;
use App\Models\AuditLog;


class RecoveriesController extends BaseController
{
    /**
     *       回收管理
     *      - 所属分类
    ...
    public function index(Request $request)
    {
        ...
        $lists = Recovery::latest('id')->where($where)->paginate(10);
        return view('manage.recoveries.index', compact('lists'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('manage.recoveries.edit', compact('info'));
    }
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function audit(RecoveryRequest $request, $id)
    {
        $info = Recovery::findOrFail($id);
        # 修改 status
    ...
    public function show($id)
    {
        ...
        return view('manage.recoveries.show', compact('info'));
    }
