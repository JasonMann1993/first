    ...
    <div class="row">
        <div class="col-xs-12">
            @include('manage.public.nav',['navs'=> [
                ['name' => '公厕列表', 'url'=> '/manage/PublicToilet'],
                ['name' => '公厕详情', 'active'=> 'true'],
            ]])
                    ...
                    <ul class="list-group">
                        ...
                        <li class="do-action">
                            <div class="col-sm-12 text-center">
                                <a class="btn btn-default" href="{{ url('/manage/PublicToilet/'. $info->id . '/edit?url=' . back()->getTargetUrl()) }}">修改信息</a>
                                @if($info->status != 0)
                        ...
                        <li class="audit" style="{{ $info->status != 0 ? 'display: none' : '' }}">
                            <h3>审核：</h3>
                            <div class="col-sm-2 label">备注</div>
                            {!! Form::open(['url' => '/manage/PublicToilet/audit/' . $info->id ,'method' => 'patch' ,'class'=> 'form-horizontal']) !!}
                            <div class="col-sm-10 text">
