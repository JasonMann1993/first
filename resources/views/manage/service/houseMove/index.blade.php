                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="status">
                                    ...
                                    @foreach(app(\App\Models\HouseMoving::class)->statusText as $key => $item)
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($lists as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/manage/service/HouseMove/' . $item->id) }}"
                                       class="btn btn-default btn-sm">详情</a>
                                    <a href="{{ url('/manage/service/HouseMove/hide/' . $item->id) }}"
