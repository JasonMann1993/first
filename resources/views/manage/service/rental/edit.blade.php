    ...
    <div class="row">
        <div class="col-xs-12">
            @include('manage.public.nav',['navs'=> [
                ['name' => '租房列表', 'url'=> '/manage/service/Rental'],
                ['name' => '编辑', 'active'=> 'true'],
            ]])
            ...
            <div class="panel panel-info">
                <div class="box-body">
                    {!! Form::model($info,['url' => '/manage/service/Rental/' . $info->id ,'method' => 'put', 'class'=> 'form-horizontal']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('form', '房屋类型', ['class' => 'control-label col-sm-2']) !!}
                        <div class="col-sm-10">
                            {!! Form::select('form', app(\App\Models\Rental::class)->formText, null, ['class' => 'form-control','required' => 'true']) !!}
                        </div>
                    </div>

                    <div class="form-group">
                        {!! Form::label('require', '出租要求', ['class' => 'control-label col-sm-2']) !!}
                        <div class="col-sm-10">
                            {!! Form::select('require', app(\App\Models\Rental::class)->requireText,null, ['class' => 'form-control','required' => 'true']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('size', '大小', ['class' => 'control-label col-sm-2']) !!}
                        <div class="col-sm-10">
                            {!! Form::text('size', null, ['class' => 'form-control','required' => 'true']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('price', '价格', ['class' => 'control-label col-sm-2']) !!}
                        <div class="col-sm-10">
