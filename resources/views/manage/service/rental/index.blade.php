                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="status">
                                    ...
                                    @foreach(app(\App\Models\Rental::class)->statusText as $key => $item)
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($lists as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/manage/service/Rental/' . $item->id) }}"
                                       class="btn btn-default btn-sm">详情</a>
                                    <a href="{{ url('/manage/service/Rental/hide/' . $item->id) }}"
