            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <ul class="list-group">
                        ...
                        <li>
                            <div class="col-sm-2 label">房屋类型</div>
                            <div class="col-sm-2 text"> {{ $info->formText[$info->form] }} </div>

                            <div class="col-sm-2 label">出租要求</div>
                            <div class="col-sm-2 text"> {{ $info->requireText[$info->require] }} </div>

                        </li>
                        <li>
                            <div class="col-sm-2 label">大小</div>
                            <div class="col-sm-2 text"> {{ $info->size }}㎡ </div>

                            <div class="col-sm-2 label">价格</div>
                            <div class="col-sm-2 text"> {{ $info->price }}</div>
                        </li>
                        <li>
                        ...
                        <li class="do-action">
                            <div class="col-sm-12 text-center">
                                <a class="btn btn-default" href="{{ url('/manage/service/Rental/'. $info->id . '/edit?url=' . back()->getTargetUrl()) }}">修改信息</a>
                                @if($info->status != 0)
                        ...
                        <li class="audit" style="{{ $info->status != 0 ? 'display: none' : '' }}">
                            <h3>审核：</h3>
                            <div class="col-sm-2 label">备注</div>
                            {!! Form::open(['url' => '/manage/service/Rental/audit/' . $info->id ,'method' => 'patch' ,'class'=> 'form-horizontal']) !!}
                            <div class="col-sm-10 text">
